        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tag_id",
                    models.CharField(
                        default=manager.defaults.tagid_generator,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                manager.models.TransactionStatus["initialized"],
                                "initialized",
                            ),
                            (
                                manager.models.TransactionStatus["requested"],
                                "requested",
                            ),
                            (manager.models.TransactionStatus["started"], "started"),
                            (manager.models.TransactionStatus["stopping"], "stopping"),
